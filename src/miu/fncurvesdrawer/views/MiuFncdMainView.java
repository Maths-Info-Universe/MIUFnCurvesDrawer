...
import miu.fncurvesdrawer.util.MIUTheme;
...
import miu.fncurvesdrawer.views.util.MIUButton;
 ...
 */
public class MiuFncdMainView extends MIUFrameModel{
    
    private JToolBar toolBar;
    private JMenuBar menuBar;
    private JPanel mainPanel;
    private MiuFncdStatePanel statePanel;
    ...
    public MiuFncdMainView(MIUConfigManager config) {
        ...
        this.controller = MiuFncdModelModel.getIHMController();
        try {
        ...
        listener = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(command.equals("theme")){
                    ((MiuFncdIHMController)controller).editDesign();
                    return;
                }
                ...
                if(command.equals("infos")){
                    MiuFncdInfosDialog dialog = new MiuFncdInfosDialog(config, true, null, desktop);
                    dialog.showDialog();
                    return;
                }
    ...
    public void initPanels() {
        ...
        statePanel = new MiuFncdStatePanel(controller);
        ...
        /*ImageIcon icon = new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/sell_small.png"));
        ...
        /*icon = new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/empty_small.png"));
    ...
    public void initMenus() {
        ...
        subMenu.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/add_small.png")));
        ...
        item.setFont(config.getTheme().getMenuFont());
        item.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/cancel_small.png")));
        ...
        item.setFont(config.getTheme().getMenuFont());
        item.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/email_small.png")));
        ...
        item.setFont(config.getTheme().getMenuFont());
        item.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/facebook_small.png")));
        ...
        item.setFont(config.getTheme().getMenuFont());
        item.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/help_small.png")));
    ...
    private void initToolBar() {
        ...
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/camera.png")));
        ...
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/gallery.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/users.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/user_add.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/stats.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/home.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/email.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/facebook.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/info.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
        ...
        button = new MIUButton(config.getTheme());
        button.setIcon(new ImageIcon(getClass().getResource("/miu/fncurvesdrawer/resources/images/help.png")));
        button.setToolTipText("<html><body><font family=\""+config.getTheme().getToolTipFont().getFamily()+"\" size=\""+config.getTheme().getToolTipSize()+"\" color=\""+MIUTheme.extractRGB(config.getTheme().getToolTipColor())+"\">"
    ...
    public class UIUpdater extends MiuFncdObserverAdapter{
